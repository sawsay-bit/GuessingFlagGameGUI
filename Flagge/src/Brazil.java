...
public class Brazil implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     Brazil(){
    	 ...
    	 icon = new ImageIcon("src/BR-Brazil-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("brazil") || input.equals("BRAZIL")) && e.getSource()==next) {
			frame.dispose();
			new Spain();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("brazil") || input.equals("BRAZIL")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Spain();
		}/*else {
			answer.setText("wrong");
