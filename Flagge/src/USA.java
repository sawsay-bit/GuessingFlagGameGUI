...
public class USA implements ActionListener,KeyListener{
     JFrame frame;
     ImageIcon icon;
     JLabel label;
     JTextField field;
     ...
     USA(){
    	 ...
    	 icon = new ImageIcon("src/United-States-Flag-1-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("united states of america") || input.equals("UNITED STATES OF AMERICA")) && e.getSource()==next) {
			frame.dispose();
			new Netherland();
		}else {
		...
		if(e.getSource()==show) {
			answer.setText("united states of america");
		}
	}
	@Override
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("united states of america") || input.equals("UNITED STATES OF AMERICA")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Netherland();
		}
	}
