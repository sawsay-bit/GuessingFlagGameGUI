...
public class Norway implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     Norway(){
    	 ...
    	 icon = new ImageIcon("src/NO-Norway-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("norway") || input.equals("NORWAY")) && e.getSource()==next) {
			frame.dispose();
			new Australia();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("norway") || input.equals("NORWAY")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Australia();
		}/*else {
			answer.setText("wrong");
