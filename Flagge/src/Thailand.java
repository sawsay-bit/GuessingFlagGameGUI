...
public class Thailand implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     Thailand(){
    	 ...
    	 icon = new ImageIcon("src/TH-Thailand-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("thailand") || input.equals("THAILAND")) && e.getSource()==next) {
			frame.dispose();
			new China();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("thailand") || input.equals("THAILAND")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new China();
		}/*else {
			answer.setText("wrong");
