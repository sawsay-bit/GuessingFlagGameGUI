...
public class Singapore implements ActionListener ,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     Singapore(){
    	 ...
    	 icon = new ImageIcon("src/SG-Singapore-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("singapore") || input.equals("SINGAPORE")) && e.getSource()==next) {
			frame.dispose();
			new Brazil();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("singapore") || input.equals("SINGAPORE")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Brazil();
		}/*else {
			answer.setText("wrong");
