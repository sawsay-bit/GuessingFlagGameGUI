...
public class England implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     England(){
    	 ...
    	 icon = new ImageIcon("src/England-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("england") || input.equals("ENGLAND")) && e.getSource()==next) {
			frame.dispose();
			new Singapore();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("england") || input.equals("ENGLAND")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Singapore();
		}/*else {
			answer.setText("wrong");
