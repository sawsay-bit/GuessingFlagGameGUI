...
public class China implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     China(){
    	 ...
    	 icon = new ImageIcon("src/CN-China-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("china") || input.equals("CHINA")) && e.getSource()==next) {
			frame.dispose();
			new England();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("china") || input.equals("CHINA")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new England();
		}/*else {
			answer.setText("wrong");
