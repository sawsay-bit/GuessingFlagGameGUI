...
public class Netherland implements ActionListener,KeyListener{
     JFrame frame;
     ImageIcon icon;
     JLabel label;
     JTextField field;
     ...
     Netherland(){
    	 ...
    	 icon = new ImageIcon("src/NL-Netherlands-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("netherland") || input.equals("NETHERLAND")) && e.getSource()==next) {
			frame.dispose();
			new French();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("netherland") || input.equals("NETHERLAND")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new French();
		}
	}
