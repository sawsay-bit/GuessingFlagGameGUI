...
public class Japan implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JTextField field;
     ...
     Japan(){
    	 ...
    	 icon = new ImageIcon("src/JP-Japan-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("japan") || input.equals("JAPAN")) && e.getSource()==next) {
			frame.dispose();
			new Korea();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("japan")|| input.equals("JAPAN")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Korea();
		}
	}
