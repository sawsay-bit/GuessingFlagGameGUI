...
public class French implements ActionListener,KeyListener{
     JFrame frame;
     ImageIcon icon;
     JLabel label;
     JTextField field;
     ...
     French(){
    	 ...
    	 icon = new ImageIcon("src/FR-France-Flag-icon.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("france") || input.equals("FRANCE")) && e.getSource()==next) {
			frame.dispose();
			new Won();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("france") || input.equals("FRANCE")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Won();
		}
	}
