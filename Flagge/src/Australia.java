...
public class Australia implements ActionListener,KeyListener{
     JFrame frame;
     JLabel label;
     ImageIcon icon;
     JLabel label1;
     ...
     Australia(){
    	 ...
    	 icon = new ImageIcon("src/AU-Australia-Flag-icon.png");
         ...
         icon1 = new ImageIcon("src/pic.jpg");
    	 
    	 label = new JLabel(icon1);
    	 label.setSize(250,280);
    	 frame.add(label);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if((input.equals("australia") || input.equals("AUSTRALIA")) && e.getSource()==next) {
			frame.dispose();
			new Japan();
		}else {
	...
	public void keyPressed(KeyEvent e) {
		// TODO Auto-generated method stub
		String input = field.getText();
		if((input.equals("australia") || input.equals("AUSTRALIA")) && e.getKeyCode()==KeyEvent.VK_ENTER) {
			frame.dispose();
			new Japan();
		}/*else {
			answer.setText("wrong");
